...
import com.pedrocosta.exchangelog.batch.parameters.BatchJobParameter;
...
public abstract class ScheduledTask<I, O> implements ItemReader<I>, ItemProcessor<I, O>, ItemWriter<O>, Cloneable {
    ...
    public ScheduledTask<I, O> setContext(ApplicationContext context) {
        ...
        setServiceFactory(context.getBean(ServiceFactory.class));
        setJobBuilderFactory(context.getBean(JobBuilderFactory.class));
        setStepBuilderFactory(context.getBean(StepBuilderFactory.class));
        setJobLauncher(context.getBean(JobLauncher.class));
        setListener(context.getBean(ScheduledTaskListener.class));
        return this;
    }
