 ...
 */
@Controller
public class BAD_NotificationRequestController extends BaseController {

    private QuoteNotificationRequestService quoteNotifReqService;

    public BAD_NotificationRequestController(ServiceFactory serviceFactory, JsonUtils jsonUtils) {
