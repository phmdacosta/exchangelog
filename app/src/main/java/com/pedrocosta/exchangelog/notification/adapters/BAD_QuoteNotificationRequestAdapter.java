package com.pedrocosta.exchangelog.notification.adapters;
...
public class BAD_QuoteNotificationRequestAdapter extends BAD_NotificationRequestAdapter<QuoteNotificationRequest> {
