...
//                    Messages.get("api.no.ccy.found", API_NAME));
     ...
     */
    public List<Exchange> getQuoteRate(String baseCode) throws NoSuchDataException, ApiException {
     ...
     * @return {@link ServiceResponse} object with a list of {@link Exchange}.
     */
    public List<Exchange> getQuoteRate(String baseCode, String[] quoteCodes) throws NoSuchDataException, ApiException {
...
//                    Messages.get("api.no.exchange.found", API_NAME));
     ...
     */
    @Override
    public List<Exchange> getQuoteRate(String baseCode, String[] quoteCodes, Double amount, Date valDate) throws NoSuchDataException, ApiException {
