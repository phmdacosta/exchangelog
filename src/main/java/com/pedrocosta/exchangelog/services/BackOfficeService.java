...
//     */
//    public List<Exchange> updateQuoteValues(String baseCcyCode) throws ServiceException {
...
//            List<Exchange> rates = apiService.getQuoteRate(
//                    baseCcyCode, null, 1D, currentDate);
//
//            if (rates.isEmpty()) {
//                Log.warn(this, "No exchange to update for "
//                        + DateUtils.dateToString(currentDate)); // TODO properties
//                return quotes;
//            }
//
...
//                }
//
//                Currency base = loadCurrency(baseCcyCode);
//                Currency quote = loadCurrency(quoteCode);
//                Date valDate = exchange.getValueDate();
//                BigDecimal baseRate = exchange.getRate();
//
//                Exchange baseCcyExch = new Exchange(base, quote, baseRate, valDate);
//                Exchange quoteCcyExch = new Exchange(base, quote, baseRate, valDate);
//
//                try {
//                    Exchange dbExch = exchService.find(base, quote, valDate);
//                    baseCcyExch.setId(dbExch.getId());
//                } catch (ServiceException ignored) {
//                }
//
//                try {
//                    // Exchange rate for base currency
//                    Exchange savedExch = exchService.save(base, quote, baseRate, valDate);
//                    quotes.add(savedExch);
//
...
//    @Override
//    public Currency loadCurrency(String code) throws JSONException, ServiceException {
